...
namespace TZTDateBlazorWebAssembly.Models.Zodiac.Entities;
...
public static class ZodiacSign
{
    ...
    public static async Task<RelationshipData> CompatibilityByZodiacSign(this User currentUser, User userForCompare)
    {
        var relationshipList = await httpClient.GetFromJsonAsync<List<RelationshipData>>("CompabilityZodiac.json");
